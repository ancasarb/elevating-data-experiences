<section class="pt-10 md:pt-32 overflow-hidden">
	<div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
		<div class="grid items-center grid-cols-1 md:grid-cols-2">
			<div>
				<h2 class="text-5xl font-bold leading-tight text-black">
					Thanks for <br class="block sm:hidden" /> stopping by! 👋
				</h2>
				<p class="text-2xl font-bold leading-tight text-black mt-6">
			...
			<div class="relative md:mx-8">
				<p class="hidden md:block mt-4 text-xl text-gray-600 md:mt-16">
					<span class="relative inline-block">
						<span class="absolute inline-block w-full bottom-0.5 h-2 bg-yellow-300" />
						<span class="relative"> Have a question? </span>
					</span>
					<a
						href="/contact"
						title=""
						class="mx-1 transition-all duration-200 text-sky-500 hover:text-sky-600 hover:underline"
						>Reach out!</a
					>
				</p>
				<p class="max-w-lg mt-3 text-xl leading-relaxed text-gray-600 md:mt-8">
				...
				<p class="md:hidden mt-4 mb-4 text-xl text-gray-600 md:mt-16">
					<span class="relative inline-block">
						<span class="absolute inline-block w-full bottom-0.5 h-2 bg-yellow-300" />
						<span class="relative"> Have a question? </span>
					</span>
					<a
						href="/contact"
						title=""
						class="md:hidden mx-1 transition-all duration-200 text-sky-500 hover:text-sky-600 hover:underline"
						>Reach out!</a
					>
				</p>
			</div>
