      ...
      <div className="container max-w-screen-lg mx-auto">
        <div>
          ...
          <p className="text-xl text-center mb-6 text-gray-700">
            Have a project idea or dataset to explore?
          </p>
          <p className="text-xl text-center mb-6 text-gray-700">
            Get in touch and let&apos;s collaborate!
          </p>
          <p className="text-xl text-center mb-6 text-gray-700">
            email: sarb.anca@gmail.com
          </p>

          <div className="flex flex-wrap justify-center gap-2">
            <a
              href="https://www.linkedin.com/in/anca-sarb/"
            ...
            <a
              href="https://github.com/ancasarb"
            ...
            <a
              href="https://twitter.com/pixel_on_canvas"
